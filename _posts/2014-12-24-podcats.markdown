...
{% include figure.html src="/assets/images/posts/podcats/IxDv2.png" caption="After a few iterations of solving the most obvious issues." retina="true" %}
...
{% include figure.html src="/assets/images/posts/podcats/track.gif" caption="After a few iterations of solving the most obvious issues." %}
