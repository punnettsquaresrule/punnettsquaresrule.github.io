...
summary: 
  ...
  content: "Podcats is a passion project to help people find new podcasts to listen to. Made in collaboration with [Niels de Hoog](https://github.com/njdehoog), we sought to build a community forum where people could recommend podcasts to each other. Having found that we found out about most podcasts via friends, we simply created a digital hub for the practice."
website:
  title: Podcats site
...
We chose to make an iPhone only app for the simple reason that our programming expertise doesn't extend to Android development. We're also both iOS users, and we were making the app for our own use as well. Sorry Android users, perhaps someday you'll have Podcats too...

![Apple's podcast app](/assets/images/posts/podcats/itunes.jpg "Apple's podcast app")


### Keep it simple, dumbass

After the bud of an idea was there, it was up to Niels and I to decide what was feasible. Seasoned app developers as we were, we still had full time jobs and social lives to contend with. We tried to decipher what was the minimum viable product could be to build an app with enough to captivate users but not so much that we'd have to work on it for a hundred years before it came out. The core of the idea was the ability to recommend podcasts to each other, and everything else was secondary. So at it's core, the app had to:
...
![MVP list](/assets/images/posts/podcats/mvp.jpg "MVP")
...
![First Sketches](/assets/images/posts/podcats/IxD.JPG "First Sketches")
...
![Podcats wireframes](/assets/images/posts/podcats/podcats_wireframes.png "Podcats wireframes")

{% include figure.html src="/assets/images/posts/podcats/IxDv2.png" caption="After a few iterations of solving the most obvious issues." %}

### Prototyping

I strongly, strongly, shout-it-from-the-mountain-tops strongly believe in the importance of prototyping. Normally my old favourite is Pop, for it's simplicity and how quickly I can test the basics on the device. More recently, I discovered prototyping in Keynote, which nearly as fast as Pop, but with the benefit of being able to prototype pretty complex animations with ease. For more high fidelity prototyping, I usually jump straight native iOS development. With such a small team, we didn't focus that much on a step by step process or keeping things really formal when building Podcats. I made a first draft of an interaction design, showed it to Niels, we made some verbal agreements and he started building away. Pretty quickly, we saw the pain points in the interaction design and could just shout out some ideas. Niels would implement them, and then we'd see if it felt right. 
...
<!-- ![Laying track](/assets/images/posts/podcats/track.gif "Laying track") -->

{% include figure.html src="/assets/images/posts/podcats/track.gif" caption="After a few iterations of solving the most obvious issues." retina="" %}
...
![Iteration 1](/assets/images/posts/podcats/Pod1.png "Iteration 1")
...
![Iteration 2](/assets/images/posts/podcats/Pod2.png "Iteration 2")
...
![Iteration 3](/assets/images/posts/podcats/Pod3.png "Iteration 3")
...
![Iteration 4](/assets/images/posts/podcats/Pod4.png "Iteration 4")

And finally: the making of the icon

![Icon](/assets/images/posts/podcats/icon.png "Icon")
...
![Tutorial](/assets/images/posts/podcats/Final0.png "Tutorial")
![Home screen](/assets/images/posts/podcats/Final1.png "Home screen")
![Detail screen](/assets/images/posts/podcats/Final2.png "Detail screen")
...
![Testers](/assets/images/posts/podcats/testing.png "Testers")
...
![Survey](/assets/images/posts/podcats/survey.png "Survey")
...
![Ship it!](/assets/images/posts/podcats/Shipit.png "Ship it!")
...
![Sketch](/assets/images/posts/podcats/Sketch.png "Sketch")

(side note - this was my first Sketch only project, and I have turned into a total Sketch cheerleader. If you're a designer, give Sketch a try. Kill Adobe with fire!)
...
![Trello](/assets/images/posts/podcats/Trello.png "Trello")
...
![Kitty](/assets/images/posts/podcats/Portrait 2.png "Kitty")

###Hindsight is 20/20

Making this app was certainly a learning process. If I could do it all over again, I would certainly do a few things differently. 
...
![Hindsight](/assets/images/posts/podcats/usage.png "Hindsight")

###Try it yourself

If you'd like to get into podcasts, or get more into podcasts, please check out Podcats in the the [app store](https://itunes.apple.com/us/app/podcats-podcast-discovery/id932391526?mt=8). If you squint really hard, you might even be able to feel the blood, sweat, and tears that went into it.

![Podcats](/assets/images/posts/podcats/PodcatsiPhone.png "Podcats")
