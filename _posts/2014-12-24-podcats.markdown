...
summary: 
    ...
    content: "I am a podcast addict. I consume more podcasts daily than I do coffee. The problem we solved with podcats is our chronic shortage of good quality podcasts."
website:
  title: Podcats site
...
Although there are a lot of podcasts providers none of them offer the discovarability we  desired.
...
My other digital haunting grounds are reddit and hackernews. What I really like about those sites is the simple mechanic to unearth possible obscure information by the use of crowdsourced curration. With the number of podcasts out there, there had to be hidden gems we could unearth using the same mechanic.
...
We tackled the challenge of realising this ambitious product by defining a feasible but extremely usefull minimal viable product.
